...
export interface StudentCertificateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "getCertificateByCourse",
    values: [AddressLike, string]
  ): string;
  encodeFunctionData(
    functionFragment: "getCertificatesByStudent",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface StudentCertificate extends BaseContract {
  connect(runner?: ContractRunner | null): StudentCertificate;
  waitForDeployment(): Promise<this>;

  interface: StudentCertificateInterface;
  ...
  getCertificateByCourse: TypedContractMethod<
    [student: AddressLike, courseId: string],
    [bigint],
    "view"
  >;

  getCertificatesByStudent: TypedContractMethod<
    [student: AddressLike],
    [bigint[]],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "getCertificateByCourse"
  ): TypedContractMethod<
    [student: AddressLike, courseId: string],
    [bigint],
    "view"
  >;
  getFunction(
    nameOrSignature: "getCertificatesByStudent"
